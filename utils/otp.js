const {setting:configSchema,userSchema:userModel} = require("../PostgresModels");
...
const sendOtp = async (phoneNumber) => {
  try {
  const url = await configSchema.findAll({where:{ id: 1}})
  const msgUrl = url[0].dataValues.smsUrl;

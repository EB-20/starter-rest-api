...
const signup = async (req, res) => {
    try {
        ...
        if (numberExists) {
            ...
            const superAdmin= await userModel.findOne({role:'SADMIN'})
            ...
            const createNewUser = new userModel({ userphoneNumber:userphoneNumber,permissions:['add-Org','add-EMP' , 'delete-EMP' , 'update-EMP' , 'view-EMP',
            ...
            const org = new orgSchema({superAdminId:superAdmin._id,planId:plan._id,phoneNumber:userphoneNumber})
